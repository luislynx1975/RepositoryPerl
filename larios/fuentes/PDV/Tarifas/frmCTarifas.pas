...
uses
  ...
  Dialogs, ExtCtrls, ComCtrls, StdCtrls, lsCombobox, Grids,
  PlatformDefaultStyleActnCtrls, ActnList, ActnMan, System.Actions,
  Data.SqlExpr;
...
begin
    ...
    begin
      SQL:= 'SELECT  FECHA_HORA_APLICA, T.ORIGEN, T.DESTINO,  S.DESCRIPCION, TD.MONTO, TD.IMP_IVA  '+
