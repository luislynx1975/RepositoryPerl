DROP PROCEDURE IF EXISTS PDV_STORE_ASIENTO_RESERVADO_PASAJERO;
DELIMITER $$
CREATE PROCEDURE PDV_STORE_ASIENTO_RESERVADO_PASAJERO(IN IN_FECHA_INPUT VARCHAR(20), IN IN_CORRIDA VARCHAR(10),
