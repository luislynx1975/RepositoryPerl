DROP PROCEDURE IF EXISTS PDV_STORE_RESERVA_ASIENTO;
DELIMITER $$
CREATE PROCEDURE PDV_STORE_RESERVA_ASIENTO(IN IN_CORRIDA VARCHAR(10), IN IN_FECHA VARCHAR(19), IN IN_ASIENTO INTEGER,
