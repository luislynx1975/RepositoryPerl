DROP PROCEDURE IF EXISTS PDV_STORE_REGISTRA_BOLETO;
DELIMITER $$
CREATE PROCEDURE PDV_STORE_REGISTRA_BOLETO(IN IN_BOLETO INTEGER, IN IN_TERMINAL VARCHAR(5), IN IN_TRABID VARCHAR(7),
