DROP PROCEDURE IF EXISTS PDV_STORE_CUPO_RUTA;
DELIMITER $$
CREATE PROCEDURE PDV_STORE_CUPO_RUTA(IN_CORRIDA VARCHAR(10),IN_HORA VARCHAR(8),IN_FECHA VARCHAR(10),IN_TERMINAL VARCHAR(7),IN_RUTA INTEGER)
BEGIN
