...
sub querys{
  my $inicio = shift;
  $qry = "SELECT ID_BOLETO, B.ID_TERMINAL, TRAB_ID, ESTATUS, ORIGEN, DESTINO, TARIFA, ID_FORMA_PAGO, ID_TAQUILLA, TIPO_TARIFA, ".
	 "FECHA_HORA_BOLETO, ID_CORRIDA, FECHA, NO_ASIENTO, ID_OCUPANTE, ESTATUS_PROCESADO,ID_RUTA, TIPOSERVICIO, ".
	 "ID_PAGO_PINPAD_BANAMEX, TC, IVA, TOTAL_IVA,  FECHA_BOLETO, HORA_BOLETO, ".
	 "TARIFA_REAL ".
...
#recorremos de forma loca		
  print( "ID_BOLETO, B.ID_TERMINAL, TRAB_ID, ESTATUS, ORIGEN, DESTINO, TARIFA, ID_FORMA_PAGO, ID_TAQUILLA, TIPO_TARIFA, ".
	 "FECHA_HORA_BOLETO, ID_CORRIDA, FECHA, NO_ASIENTO, ID_OCUPANTE, ESTATUS_PROCESADO,ID_RUTA, TIPOSERVICIO, ".
	 "ID_PAGO_PINPAD_BANAMEX, TC, IVA, TOTAL_IVA, FECHA_BOLETO, HORA_BOLETO, ".
	 "TARIFA_REAL ");
